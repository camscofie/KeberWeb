...
* Display on the latest downloads using a shortcode.
...
= 1.0.7 =
* Added a "Latest Downloads" shortcode to allow users to display a finite number of their latest and greatest downloads.
